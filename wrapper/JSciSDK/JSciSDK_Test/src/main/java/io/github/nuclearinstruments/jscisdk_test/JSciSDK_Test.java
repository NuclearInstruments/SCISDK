...
import io.github.NuclearInstruments.jscisdk.FrameDecodedBuffer;
import io.github.NuclearInstruments.jscisdk.FramePacket;
...
public class JSciSDK_Test {
    ...
    public static void main(String[] args) throws SciSDKException, InterruptedException {
        ...
        int res = sdk.AddNewDevice("usb:28645", "DT1260", "C:\\git\\scisdk\\examples\\components\\Python\\Frame\\DT1260RegisterFile.json", "board0");
        if (res != 0) {
