...
namespace Oscilloscope
{
    ...
    class TofSpectrumGraph
    {
        PlotView plot_view = null;
        LinearAxis x_axis;
        LinearAxis y_axis;

        public TofSpectrumGraph(Point position, Size size)
        {
            ...
            // initialize axis
            x_axis = new LinearAxis { Position = AxisPosition.Bottom, Title = "", AbsoluteMinimum = 0, AbsoluteMaximum = 1024 };
            ...
            plot_view.Anchor = (AnchorStyles.Left | AnchorStyles.Right | AnchorStyles.Top | AnchorStyles.Bottom);
        }
