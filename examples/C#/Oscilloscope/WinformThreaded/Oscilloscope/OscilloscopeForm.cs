...
namespace Oscilloscope
{
    public partial class OscilloscopeForm : Form
    {
        ...
        private void btn_start_Click(object sender, EventArgs e)
        {
            ...
            // start reading data
            graph_update.StartRead(Thread.CurrentThread, btn_stop, lbl_status, txt_horizontal_divisions, track_pretrigger, track_trigger_level, channels_enabled, cmb_trigger_source, cmb_trigger_polarity, cmb_trigger_mode);
        }
