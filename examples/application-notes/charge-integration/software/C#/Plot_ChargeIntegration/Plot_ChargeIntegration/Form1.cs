...
namespace Plot_ChargeIntegration
{
    public partial class Form1 : Form
    {
        ...
        private PlotView plot_view3;
        private PlotModel model1;
        private PlotModel model2;
        private PlotModel model3;
        ...
        public Form1()
        {
            ...
            //===================================================
            Spectrum = new LineSeries();
            model3.Series.Add(Spectrum);

            // Set the axis titles
            model3.Axes.Add(new LinearAxis { Position = AxisPosition.Left, Title = "Counts" });
            model3.Axes.Add(new LinearAxis { Position = AxisPosition.Bottom });
            ...
            plot_view3 = new OxyPlot.WindowsForms.PlotView { Dock = DockStyle.Fill, Model = model3 };

            table.Controls.Add(plot_view1);
            table.Controls.Add(plot_view2);
            table.Controls.Add(plot_view3);
            ...
            t1.Size = new System.Drawing.Size(70, 100);
            t1.RowCount = 1;
            t1.ColumnCount = 3;
            ...
            var restartButton = new Button { Text = "Restart", Dock = DockStyle.Fill };
            ...
            t3.Size = new System.Drawing.Size(200, 30);
            t3.RowCount = 13;
            t3.ColumnCount = 2;
        ...
        private void Timer_Elapsed(object? sender, ElapsedEventArgs e)
        {
            ...
            if (res == 0)
            {
                ...
                {
                    Spectrum.Points.Add(new DataPoint(i, values[i]));
                }
