#ifndef HEADER_H_SCISDK_2DHISTOGRAM
#define HEADER_H_SCISDK_2DHISTOGRAM
#include <iostream>
#include <algorithm>
#include <list>
...
class SciSDK_2DHistogram : public  SciSDK_Node {
public:
	SciSDK_2DHistogram(SciSDK_HAL *hal, json j, string path);
