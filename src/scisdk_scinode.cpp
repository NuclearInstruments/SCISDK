...
NI_RESULT SciSDK_Node::SetParam(string name, uint32_t value) {
	...
	if (type == "boardapi") {
		...
		if (FindBoardApiParameterByName(name, &p)) {
			return p->caller->ISetParamU32(name, value);
		}
		else {
			return NI_NOT_FOUND;
		}
...
NI_RESULT SciSDK_Node::SetParam(string name, int32_t value) {
	...
	if (type == "boardapi") {
		...
		if (FindBoardApiParameterByName(name, &p)) {
			return p->caller->ISetParamI32(name, value);
		}
		else {
			return NI_NOT_FOUND;
		}
...
NI_RESULT SciSDK_Node::SetParam(string name, uint64_t value) {
	...
	if (type == "boardapi") {
		...
		if (FindBoardApiParameterByName(name, &p)) {
			return p->caller->ISetParamU64(name, value);
		}
		else {
			return NI_NOT_FOUND;
		}
...
NI_RESULT SciSDK_Node::SetParam(string name, int64_t value) {
	...
	if (type == "boardapi") {
		...
		if (FindBoardApiParameterByName(name, &p)) {
			return p->caller->ISetParamI64(name, value);
		}
		else {
			return NI_NOT_FOUND;
		}
...
NI_RESULT SciSDK_Node::SetParam(string name, double value) {
	...
	if (type == "boardapi") {
		...
		if (FindBoardApiParameterByName(name, &p)) {
			return p->caller->ISetParamDouble(name, value);
		}
		else {
			return NI_NOT_FOUND;
		}
...
NI_RESULT SciSDK_Node::GetParam(string name, uint32_t *value) {
	...
	if (type == "boardapi") {
		if (FindBoardApiParameterByName(name, &p)) {
			return p->caller->IGetParamU32(name, value);
		}
		else {
			return NI_NOT_FOUND;
		}
...
NI_RESULT SciSDK_Node::GetParam(string name, int32_t *value) {
	...
	if (type == "boardapi") {
		if (FindBoardApiParameterByName(name, &p)) {
			return p->caller->IGetParamI32(name, value);
		}
		else {
			return NI_NOT_FOUND;
		}
...
NI_RESULT SciSDK_Node::GetParam(string name, uint64_t *value) {
	...
	if (type == "boardapi") {
		if (FindBoardApiParameterByName(name, &p)) {
			return p->caller->IGetParamU64(name, value);
		}
		else {
			return NI_NOT_FOUND;
		}
...
NI_RESULT SciSDK_Node::GetParam(string name, int64_t *value) {
	...
	if (type == "boardapi") {
		if (FindBoardApiParameterByName(name, &p)) {
			return p->caller->IGetParamI64(name, value);
		}
		else {
			return NI_NOT_FOUND;
		}
...
NI_RESULT SciSDK_Node::GetParam(string name, double *value) {
	...
	if (type == "boardapi") {
		if (FindBoardApiParameterByName(name, &p)) {
			return p->caller->IGetParamDouble(name, value);
		}
		else {
			return NI_NOT_FOUND;
		}
