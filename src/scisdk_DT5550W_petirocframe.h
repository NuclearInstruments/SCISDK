#ifndef HEADER_H_SCISDK_DT5550W_PETIROCFRAME
#define HEADER_H_SCISDK_DT5550W_PETIROCFRAME
#include <iostream>
#include <algorithm>
#include <list>
...
class SciSDK_DT5550W_PetirocFrame : public  SciSDK_Node {
public:
	SciSDK_DT5550W_PetirocFrame(SciSDK_HAL *hal, json j, string path);
