#ifndef HEADER_H_SCISDK_OSCILLOSCOPE_DUAL
#define HEADER_H_SCISDK_OSCILLOSCOPE_DUAL
#include <iostream>
#include <algorithm>
#include <list>
...
class SciSDK_Oscilloscope_Dual : public  SciSDK_Node {
public:
	SciSDK_Oscilloscope_Dual(SciSDK_HAL *hal, json j, string path);
