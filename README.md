...
The library can also be compiled in Windows or Linux to generate a dynamic or a static library that can be linked to the user application. See [SciSDK compilation](docs/compilation.md) for more information.
